  ...
  de: {
    translation: {
      ...
      results: {
        ...
        print: { title: "ZTNA Scout Analysebericht", summary: "Management Summary", seats: "Benutzerlizenzen", top_recommendation: "Top Empfehlung", transparency_title: "Transparenz & Quellen", transparency_desc: "Die Berechnungen basieren auf öffentlichen Marktlistenpreisen (EUR)." },
  ...
  fr: {
    translation: {
      ...
      results: {
        ...
        print: { title: "Rapport d'analyse ZTNA Scout", summary: "Résumé Exécutif", seats: "Utilisateurs", top_recommendation: "Meilleure recommandation", transparency_title: "Transparence & Sources", transparency_desc: "Calculs basés sur les prix publics (EUR)." },
      ...
      admin: {
        ...
        tabs: { pipeline: "Pipeline", pricing: "Prix", settings: "Syst��me" },
