    ...
    translation: {
      ...
      layout: {
        ...
        footer: {
          ...
          service_line: "A strategic security service by von Busch GmbH",
      ...
      results: {
        ...
        chart: { calculated_tco: "Calculated 1-Year TCO" },
        print: {
          title: "ZTNA Scout Analysis Report",
          tagline: "Market Assessment Report – Generated by ZTNA Scout",
        ...
        matrix: {
          ...
          comparison_title: "Capability Comparison",
          ...
          expert_take_desc: {
            features: "Includes ZTNA, SWG, CASB, DLP, and RBI capabilities.",
            price: "Competitiveness relative to the calculated market average.",
            compliance: "Based on BSI qualifications and regional certifications."
          },
          features: {
  ...
  de: {
    translation: {
      ...
      layout: {
        ...
        footer: { imprint: "Impressum", privacy: "Datenschutz", service_line: "Ein strategischer Sicherheitsdienst der von Busch GmbH", address: "von Busch GmbH – Alfred-Bozi-Straße 12 – 33602 Bielefeld" }
      },
      home: {
        hero: {
          ...
          description: "Schluss mit Sch��tzungen. Vergleichen Sie 13+ ZTNA-Anbieter mit deterministischen TCO-Projektionen und BSI-Konformitätsbewertungen.",
      ...
      results: {
        ...
        matrix: {
          ...
          comparison_title: "Fähigkeiten-Vergleich",
          capability: "Funktion",
          ...
          close_analysis: "Analyse schließen",
          ...
          expert_take_desc: {
            features: "Beinhaltet ZTNA, SWG, CASB, DLP und Isolationsfunktionen.",
            price: "Wettbewerbsfähigkeit im Vergleich zum Marktdurchschnitt.",
            compliance: "Basiert auf BSI-Qualifizierungen und Sicherheitszertifikaten."
          },
          features: {
            hasZTNA: "Zero Trust Network Access",
            hasSWG: "Secure Web Gateway",
  ...
  fr: {
    translation: {
      ...
      results: {
        ...
        live_sample_mode: "MODE DÉMO LIVE.",
        ...
        disclaimer: "Estimations basées sur les prix catalogue.",
        ...
        chart: { calculated_tco: "TCO calculé sur 1 an" },
        print: { title: "Rapport d'analyse ZTNA Scout", tagline: "Rapport d'évaluation du marché – généré par ZTNA Scout", summary: "Résumé Exécutif", seats: "Utilisateurs", top_recommendation: "Meilleure recommandation", transparency_title: "Transparence & Sources", transparency_desc: "Calculs basés sur les prix publics (EUR)." },
        badges: {
        ...
        matrix: {
          ...
          comparison_title: "Comparaison des capacités",
          capability: "Fonctionnalité",
          show_all: "Toutes les lignes",
          diff_only: "Différences",
          best_fit: "Meilleur choix",
          deep_dive: "Détails",
          feature_score: "Richesse (40%)",
          price_score: "Prix (40%)",
          compliance_score: "Conformité (20%)",
          total_score: "Score Scout",
          analytical_breakdown: "Analyse détaillée",
          market_position: "Rang",
          close_analysis: "Fermer l'analyse",
          market_rank: "Rang",
          rank_1: "1re place",
          rank_2: "2e place",
          rank_3: "3e place",
          scout_total: "Total Scout",
          close_deep_dive: "Fermer",
          expert_take_desc: {
            features: "Inclut les capacités ZTNA, SWG, CASB, DLP et RBI.",
            price: "Compétitivité par rapport à la moyenne du marché.",
            compliance: "Basé sur les qualifications BSI et les certifications régionales."
          },
          features: {
            hasZTNA: "Zero Trust Network Access",
            hasSWG: "Secure Web Gateway",
