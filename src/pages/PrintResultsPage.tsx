...
export function PrintResultsPage() {
  ...
  return (
    <div className="p-8 max-w-[21cm] mx-auto bg-white text-black print:p-0">
        ...
        <table className="w-full text-[10px] border-collapse">
          <thead>
            <tr className="bg-black text-white">
              ...
              <th className="p-2 text-center border">BSI Compliance</th>
          ...
          <tbody>
            {sortedResults.map((r) => (
              <tr key={r.vendorId} className="border-b">
                ...
                <td className="p-2 text-center border font-semibold">{r.features.isBSIQualified ? 'YES' : 'Standard'}</td>
      ...
      <footer className="mt-12 pt-4 border-t text-[9px] text-gray-400 flex justify-between">
        <p>© 2024 ZTNA Scout — B2B Comparison Engine</p>
