...
// Register all user-facing API routes up-front.
// This avoids production issues where dynamic imports can fail during bundling/deploy
// (e.g. "No such module ./user-routes"), which previously broke the live sample.
userRoutes(app);
